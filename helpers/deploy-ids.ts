...
export const ATOKEN_IMPL_ID = `TToken-${MARKET_NAME}`;
...
export const ORACLE_ID = `TaralendOracle-${MARKET_NAME}`;
...
export const AAVE_COLLECTOR_PROXY_ID = `TaralendCollector-${PROXY_ID}-${MARKET_NAME}`;
export const AAVE_COLLECTOR_IMPL_ID = `TaralendCollector-${IMPL_ID}-${MARKET_NAME}`;
...
export const ATOKEN_PREFIX = `-TToken-${MARKET_NAME}`;
...
export const STAKE_AAVE_PROXY = `StakeTaralend-${PROXY_ID}`;
export const STAKE_AAVE_IMPL_V1 = `StakeTaralend-REV-1-${IMPL_ID}`;
export const STAKE_AAVE_IMPL_V2 = `StakeTaralend-REV-2-${IMPL_ID}`;
export const STAKE_AAVE_IMPL_V3 = `StakeTaralend-REV-3-${IMPL_ID}`;
